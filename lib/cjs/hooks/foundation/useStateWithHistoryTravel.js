 ...
 */
function useStateWithHistoryTravel(initialValue) {
    ...
    var updateValue = (0, react_1.useCallback)(function (val) {
        setHistory({
            present: val,
            future: [],
    ...
    var _forward = (0, react_1.useCallback)(function (step) {
    ...
    var _backward = (0, react_1.useCallback)(function (step) {
        if (step === void 0) { step = -1; }
        if (past.length === 0) {
            return;
        }
    ...
    var go = (0, react_1.useCallback)(function (step) {
    ...
    return [
        ...
        updateValue,
        {
            ...
            go: go,
            back: (0, react_1.useCallback)(function () { return go(-1); }, [go]),
            forward: (0, react_1.useCallback)(function () {
                go(1);
            }, [go]),
            reset: reset,
        },
...
exports.default = useStateWithHistoryTravel;
